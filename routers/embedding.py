...
@router.put("/embedding", response_model=EmbeddingResponse)
async def update_embedding(
    request: EmbeddingRequest,
    db: Session = Depends(get_write_db)
):
    """
    Update embedding vector for a specific product.
    
    Designed to be called by Java backend when product data is updated.
